...
Use of a programming language requires some ability to meantally visualize data objects and their manipulation and relate these objects to symbolic variable names and commands.
